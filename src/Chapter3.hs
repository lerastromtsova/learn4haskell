...
{-
Actually I don't see the point in writing separate
Monster and Knight types as their properties are the same
-}
...
daysToParty x = case x of
    Saturday -> 6
    Sunday -> 5
    _ -> length (enumFromTo x Friday) - 1
